...
export default {
  ...
  MESSAGES: {
    ...
    PROJECTMASTER_PF: {
      PROJECTMASTER_ALREADY_EXISTS: "PROJECTMASTER ALREADY EXISTS",
      PROJECTMASTER_DOES_NOT_EXISTS: "PROJECTMASTER DOES NOT EXISTS",
      PROJECTMASTER_CREATED_SUCCESSFULLY: "PROJECTMASTER ADDED SUCCESSFULLY",
      PROJECTMASTER_UPDATED_SUCCESSFULLY: "PROJECTMASTER UPDATED SUCCESSFULLY",
      SELECT_AT_LEAST_ONE_PROJECTMASTER: "SELECT AT LEAST ONE PROJECTMASTER",
      PROJECTMASTER_DELETED_SUCCESSFULLY: "PROJECTMASTER DELETED SUCCESSFULLY",
    },
